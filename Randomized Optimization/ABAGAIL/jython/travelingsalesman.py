...
for cities in x:
    ...
    print "RHC Inverse of Distance: " + str(ef.value(rhc.getOptimal())) + " in " + str(end-start) + " seconds"
    print "Route:"
    path = []
    for x in range(0,N):
    ...
    print "SA Inverse of Distance: " + str(ef.value(sa.getOptimal())) + " in " + str(end-start) + " seconds"
    print "Route:"
    path = []
    for x in range(0,N):
    ...
    print "GA Inverse of Distance: " + str(ef.value(ga.getOptimal())) + " in " + str(end-start) + " seconds"
    print "Route:"
    path = []
    for x in range(0,N):
    ...
    print "MIMIC Inverse of Distance: " + str(ef.value(mimic.getOptimal())) + " in " + str(end-start) + " seconds"
    print "Route:"
    path = []
